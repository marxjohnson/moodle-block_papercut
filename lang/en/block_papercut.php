...
/**
 * Defines the lang strings for the Quick Course List block
 *
...
$string['clienttitle'] =  'Please enter text to be displayed as the block title';

$string['serverurl'] =  'Server Url';
$string['clientserverurl'] =  'Please enter the url of the papercut server. (http:// not '
    .'required)';
...
$string['clientusehttps'] = 'Use HTTPS for the connection to the Papercut server? You\'ll need to '
